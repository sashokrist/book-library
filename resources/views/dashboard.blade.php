<x-app-layout>
    ...
    <x-slot name="header">
        ...
        @if(auth()->user() && auth()->user()->isAdmin)
            ...
            <a href="{{ route('books.create') }}" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700">Create New Book</a>

            <a href="{{ route('users.manage') }}" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">Manage users</a>
        @endif
    </x-slot>
            ...
            @else
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-gray-100 text-center">
                        ...
                        @else
                            <p class="text-lg">{{ __("You're logged in as a regular user! ") }} {{ auth()->user()->name }}.</p>
                        @endif
